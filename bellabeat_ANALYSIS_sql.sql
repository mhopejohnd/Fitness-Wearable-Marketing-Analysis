...
-- WHAT DO I WANT TO KNOW
	...
	-- HOW MANY UNIQUE USERS ARE THERE?   35
    -- HOW MANY USERS PER DAY TOOK AT LEAST 1 STEP (FOUND AMOUNT OF ACTIVE USERS PER DAY)? COMPLETE
    -- MAYBE FIND HOW THEIR ACTIVITY (E.G. DAILY STEPS, SLEEP, ETC) CORRELATES TO WEEKDAYS VS. WEEKENDS COMPLETE
    -- FIND DIFFERENT MEASUREMENTS (SLEEP, DAILY STEPS, ACTIVE DISTANCE, ACTIVE MINUTES)
		-- WEEKDAY STEP AVERAGE FOR EACH USER ID
        -- WEEKDAY SLEEP AVERAGE FOR EACH USER ID
    -- TRACKER ACTIVITY VS. MEASURES ACTIVITY INSURES ACCURACY          so this doesn't mean the same thing, have to figure out what the difference is
    -- SEE IF THERE SHOWS A PATTERN IN A pERSONS SLEEP                  MADE TABLE FOR WEEKDAY ANALYSIS
																-- 		WEEKLY ANALYSIS
    -- MAYBE YOU CAN ADD A DAY OF THE WEEK COLUMN, SO IT WOULD BE EASIER TO ANALYZE  DONE
    
    -- INFORMATION ON ACTIVE USERS VS. NON-ACTIVE USERS <-- MIGHT ALLOW FOR GREATER AUDIENCE IF NOT JUST SUITED FOR FIT INDIVIDUALS, MORE EVERYDAY HEALTH
    -- WHAT OTHER HEALTH/LIFESTYLE PARAMETERS CAN APPLY SINCE BELLABEAT HAS A LOT OF DEVICES
